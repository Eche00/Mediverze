...
function Hero() {
  ...
  return (
   ...
   {/* info section  */}
      <section className=" flex flex-col gap-[4px] p-6">
        ...
        <p className=" text-gray-200 text-[16px] sm:text-[24px] mt-1 flex items-center">{"> "}
          {location.pathname === '/user/courses' && 'All'}
          {location.pathname === '/user/courses/200l' && '200 Level'}
          {location.pathname === '/user/courses/300l' && '300 Level'}
          {location.pathname === '/user/courses/400l' && '400 Level'}
